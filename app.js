        ...
        User.findOne({ username: username }, (err) => {
            ...
            if (gameRooms[game].players.length === 2) {
                io.to(game).emit('game start', {
                    game,
                    players: [
                        gameRooms[game].players[0].username,
                        gameRooms[game].players[1].username,
                    ],
                })
            }
        })
            ...
            switch (moves[round][0]['move']) {
                case 'rock': {
                    ...
                    if (moves[round][1]['move'] === 'paper') {
                        if (moves[round][1]['player'] === gr.playerOne.username)
                            gr.p1Wins += 1
                        if (moves[round][1]['player'] === gr.playerTwo.username)
                            gr.p2Wins += 1
                    ...
                    if (moves[round][1]['move'] === 'scissors') {
                        if (moves[round][0]['player'] === gr.playerOne.username)
                            gr.p1Wins += 1
                        if (moves[round][0]['player'] === gr.playerTwo.username)
                            gr.p2Wins += 1
