    ...
    componentDidMount() {
        ...
        this.socket.on('connect', (socket) => {
            ...
            this.socket.on('join', (data) => {
                this.setState({
                    openRooms: [...this.state.openRooms, data.gameName],
        ...
        if (stage === 1) {
            ...
            display = (
                <LiveGame
                    ...
                    handleRock={this.handleRock}
                    handlePaper={this.handlePaper}
                    handleScissors={this.handleScissors}
                />
            )
        } else if (stage === 4) {
            ...
            display = (
                <RoundResult
                    ...
                    loser={users.players.filter((user) => user !== winner)}
